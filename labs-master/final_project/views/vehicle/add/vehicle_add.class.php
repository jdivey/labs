...
<!--            <input type="hidden" name="id" value="--><?//= $id ?><!--">-->
            ...
            <p><strong>Year</strong>: <input name="year" type="number" required=""></p>
            <p><strong>Price</strong>: <input name="price" type="number"  required=""></p>
            ...
            <p><strong>Image</strong>: url (http:// or https://) or local file including path and file extension<br>
                <input name="image" type="url" size="100" ></p>
            <p><strong>Description</strong>:<br>
                <textarea name="description" rows="8" cols="100"></textarea></p>
            <input type="submit" name="action" value="Add Vehicle">
            <input type="button" value="Cancel" onclick='window.location.href = "<?= BASE_URL . "/vehicle/index/"?>"'>
        </form>
<?php
        //display page footer
